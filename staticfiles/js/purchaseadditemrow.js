...
var trntype='';
  ...
  function calculateTotal(rowNumber) {
    ...
    const incscheck = document.getElementById(`incltax${rowNumber}`).value;
...
const discamount= document.getElementById('discamt').value
  ...
  function discountpercent() {
    discperc='0.00'
    const amt=document.getElementById('nettotal').value;
...
tblrow.onclick = () => selectitem(customer.id,customer.name,customer.bcode,customer.ilang, customer.srate,customer.incs,customer.vat,customer.itemcode, rowNumber);
...
console.log("my bcode", document.getElementById(`barcode${1}`).value)
     for (let i = 1; i <=tableBody.rows.length ; i++) {
  ...
  var rows = tableBody.getElementsByTagName('tr');
    ...
    const typ='bcode'
      ...
      function displaybarcodeitem(items,rowNumber) {
        ...
        document.getElementById(`total${rowNumber}`).value ='';
      document.getElementById(`tax${rowNumber}`).value ='';
       document.getElementById(`net-amt${rowNumber}`).value ='';
      ...
      document.getElementById(`qty${rowNumber}`).value=1;
              document.getElementById(`itemname${rowNumber}`).value =item.name;
                 ...
                 document.getElementById(`ilang${rowNumber}`).value = item.ilang;
                              document.getElementById(`srate${rowNumber}`).value = item.prate;
                              document.getElementById(`incltax${rowNumber}`).value=item.incp;
...
function Loaddata(){
 ...
 const tableBody = document.getElementById('invoice-form-items-table-body');
  ...
  function addRow() {
    ...
    <td class="form-input-td"><input name="barcode" style="min-width:230px;" id="barcode${rowNumber}" onclick="getrow(${rowNumber},event)" onblur="getbarcodeitem(${rowNumber})"  onkeydown="handleKeyDown(event,${rowNumber});getrow(${rowNumber},event)"  oninput="search(${rowNumber}) " type="text" class="form-control"   placeholder="Barcode"></td>
...
<td class="form-input-td"><input type="number" name="qty" style="min-width:100px;" class="form-control"  id="qty${rowNumber}" style="min-width:100px;" placeholder="0.00" ondblclick="itemedit(${index2})" onkeydown="qtykeydown(event,${rowNumber})" oninput="calculateTotal(${rowNumber})" onclick="getrow(${rowNumber},event)" required></td>
   
<td class="form-input-td"><input type="number" name="srate" id="srate${rowNumber}" style="min-width:100px;" oninput="calculateTotal(${rowNumber})" class="form-control" placeholder="0.00" onclick="getrow(${rowNumber},event)" onkeydown="nextrowkey(event,${rowNumber})" required ></td>
      <td class="form-input-td"><input type="text" name="amt" style="min-width:100px;" class="form-control" placeholder="0.00"  id="total${rowNumber}" onclick="getrow(${rowNumber},event)" readonly></td>
      <td class="form-input-td"><input type="text" name="tax" style="min-width:100px;" id="tax${rowNumber}"   class="form-control" placeholder="0.00" oninput="calculateTotal(${rowNumber})" onclick="getrow(${rowNumber},event)" required></td>

      <td><input type="text" name="netamt" style="min-width:100px;" id="net-amt${rowNumber}"  class="form-control" placeholder="0.00"  onclick="getrow(${rowNumber},event)" readonly></td>
         <input type="text" name="itemid" style="min-width:100px;" id="itemid${rowNumber}" hidden="true" class="form-control"  >
          ...
          <input type="number" name="incl" style="min-width:100px;" id="incltax${rowNumber}" hidden="true" class="form-control">
            </td>
...
//  let query= parseInt(vno.value)-1;
       fetch(`/getpreviouspurchase/?query=${vno}&vtype=${vtype}`)
                .then(response => response.json())
                .then(data => displayprevious(vno,data.data2,data.data1,data.lvno)
                  
                  );

  }

  function displayprevious(curvno, recieptdetails,transactionreceipt,lvno){
...
document.getElementById('nettotal').value='0.00';
    ...
    transactionreceipt.forEach((customer,index) => {
      ...
      document.getElementById(`refno`).value=customer.refno;
      ...
      popupImage.src = customer.billimg;
      }
      // document.getElementById(`imageInput`).value=customer.billimg;
...
pay.value=28;
  ...
  function receiptdetailsprev(recieptdetails){
   ...
   rowNumber=index2;
      ...
      newRow.innerHTML = `
      <td class="" >${rowNumber}</td>
      <td class="form-input-td"><input name="barcode" style="min-width:230px;" id="barcode${index2}" type="text" onchange="checkfn()" onblur="getbarcodeitem(${rowNumber})" onkeydown="handleKeyDown(event,${index2});getrow(${index2},event)"  oninput="search(${index2}) " onchange="calculateTotal(${index2})" onclick="getrow(${rowNumber},event)" class="form-control"   placeholder="Barcode"></td>
      <td class="form-input-td"><input name="itemcode" style="min-width:150px;" id="itemcode${index2}" type="text" class="form-control"   placeholder="Itemcode" onclick="getrow(${rowNumber},event)" readonly></td>

        <td class="form-input-td"><input  name="itemname" style="min-width:250px;"    id="itemname${index2}" class="form-control"  type="text" placeholder="Itemname" onclick="getrow(${rowNumber},event)" readonly></td>
  <td class="form-input-td"><input name="ilang" id="ilang${index2}"  style="min-width:150px;" type="text" class="form-control"   placeholder="second lang" onclick="getrow(${rowNumber},event)" readonly></td>
  <td class="form-input-td"><input type="" name="qty" style="min-width:100px;" class="form-control"  id="qty${index2}" style="min-width:100px;" ondblclick="itemedit(${index2})" onkeydown="qtykeydown(event,${index2})" oninput="calculateTotal(${index2})" onclick="getrow(${rowNumber},event)" required></td>
  <td class="form-input-td"><input type="" name="srate" id="srate${index2}" style="min-width:100px;"  oninput="calculateTotal(${index2})" class="form-control" onkeydown="nextrowkey(event,${index2})" onclick="getrow(${rowNumber},event)" required ></td>

        <td class="form-input-td"><input type="text" name="amt" style="min-width:100px;"  class="form-control"  id="total${index2}" onclick="getrow(${rowNumber},event)" readonly></td>
       <td class="form-input-td"><input type="text" name="tax" style="min-width:100px;" id="tax${index2}" placeholder="tax"  class="form-control" oninput="calculateTotal(${index2})" onclick="getrow(${rowNumber},event)"   required></td>
  
        <td><input type="text" name="netamt" style="min-width:100px;" id="net-amt${index2}"  class="form-control" onclick="getrow(${rowNumber},event)"   onkeydown="nextrowkey(event)" readonly></td>
      <input type="text" name="itemid" style="min-width:100px;" id="itemid${index2}" hidden="true" class="form-control"  >
           ...
           <input type="text" name="validate" style="min-width:100px;" id="validate${index2}" hidden="true" class="form-control"  >
                    <input type="number" name="incl" style="min-width:100px;" id="incltax${index2}" hidden="true" class="form-control">
  ...
  let query=customer.pcode
    ...
    fetch(`/getitem/?query=${query}&type=${typ}`)
      ...
      function setitem(itemdata,rownum){
        ...
        // document.getElementById(`total${rownum}`).value =customer.rate*customer.tempqty;
        document.getElementById(`net-amt${rownum}`).value = customer.netamt;
        document.getElementById(`incltax${rownum}`).value=item.incp;
        let incscheck = document.getElementById(`incltax${rownum}`).value;
       if(incscheck==1){
  ...
  //  let query= parseInt(vno.value)-1;
         ...
         fetch(`/getprevious/?query=${vno}&vtype=${vtype}`)
                  .then(response => response.json())
                  .then(data => displaypreviousPR(vno,data.data2,data.data1,data.lvno)
                    
                    );
  
    }
  
    function displaypreviousPR(curvno,issuedetails,buisnessissue,lvno){
  ...
  pay.value=28;
        ...
        fetch(`/getcustomer/?query=${query}`)
            .then(response => response.json())
            .then(data =>getcusPR(data.customers)
  ...
  var index2;
     ...
     rowNumber=index2;
        ...
        newRow.innerHTML = `
        <td class="" >${rowNumber}</td>
        <td class="form-input-td"><input name="barcode" style="min-width:230px;" id="barcode${index2}" type="text" oninput="search(${index2}) " onkeydown="handleKeyDown(event,${index2});getrow(${index2},event)" onblur="getbarcodeitem(${rowNumber})" onchange="calculateTotal(${index2})"  onclick="getrow(${rowNumber},event)" onchange="checkfn()" class="form-control"   placeholder="Barcode"></td>
        <td class="form-input-td"><input name="itemcode" style="min-width:150px;" id="itemcode${index2}" type="text"  class="form-control"   placeholder=Itemcode" onclick="getrow(${rowNumber},event)" readonly></td>
          <td class="form-input-td"><input  name="itemname" style="min-width:250px;"  id="itemname${index2}" class="form-control"  type="text" placeholder="Itemname" onclick="getrow(${rowNumber},event)" readonly></td>
    ...
    <td class="form-input-td"><input type="" name="srate" id="srate${index2}" style="min-width:100px;"  oninput="calculateTotal(${index2})" class="form-control" onkeydown="nextrowkey(event,${index2})" onclick="getrow(${rowNumber},event)" required ></td>
         ...
         <td class="form-input-td"><input type="text" name="tax" style="min-width:100px;" id="tax${index2}" placeholder="tax"  class="form-control" oninput="calculateTotal(${index2})" onclick="getrow(${rowNumber},event)"  required></td>
          ...
          <td><input type="text" name="netamt" style="min-width:100px;" id="net-amt${index2}"  class="form-control" onclick="getrow(${rowNumber},event)"  readonly></td>
                <input type="text" name="itemid" style="min-width:100px;" id="itemid${index2}" hidden="true" class="form-control"  >
               <input type="text" name="vat" style="min-width:100px;" id="vat${index2}" hidden="true" class="form-control"  >
               <input type="text" name="validate" style="min-width:100px;" id="validate${index2}" hidden="true" class="form-control"  >
                   <input type="number" name="incl" style="min-width:100px;" id="incltax${index2}" hidden="true" class="form-control">
...
//  let query= parseInt(vno.value)-1;
       ...
       fetch(`/getpreviouspurchase/?query=${vno}&vtype=${vtype}`)
                .then(response => response.json())
                .then(data => displaypreviouspo(vno,data.data2,data.data1,data.lvno)
                  
                  );

  }

  function displaypreviouspo(curvno,recieptdetails,transactionreceipt,lvno){
  console.log(transactionreceipt)
  if(lvno==0){
    document.getElementById(`vno`).value=curvno
    addRow()
...
pay.value=28;
  ...
  function receiptdetailsprev(recieptdetails){
   ...
   rowNumber=index2;
      ...
      newRow.innerHTML = `
      <td class="" >${rowNumber}</td>
      <td class="form-input-td"><input name="barcode" style="min-width:150px;" id="barcode${index2}" type="text" onchange="checkfn()" onblur="getbarcodeitem(${rowNumber})" onkeydown="handleKeyDown(event,${index2});getrow(${index2},event)"  oninput="search(${index2}) " onchange="calculateTotal(${index2})" onclick="getrow(${rowNumber},event)" class="form-control"   placeholder="Barcode"></td>
      <td class="form-input-td"><input name="itemcode" style="min-width:150px;" id="itemcode${index2}" type="text" class="form-control"   placeholder="Itemcode" onclick="getrow(${rowNumber},event)" readonly></td>

        <td class="form-input-td"><input  name="itemname" style="min-width:350px;"    id="itemname${index2}" class="form-control"  type="text" placeholder="Itemname" onclick="getrow(${rowNumber},event)" readonly></td>
  <td class="form-input-td"><input name="ilang" id="ilang${index2}"  style="min-width:150px;" type="text" class="form-control"   placeholder="second lang" onclick="getrow(${rowNumber},event)" readonly></td>
  <td class="form-input-td"><input type="" name="qty" style="min-width:100px;" class="form-control"  id="qty${index2}" style="min-width:100px;" ondblclick="itemedit(${index2})" oninput="calculateTotal(${index2})" onclick="getrow(${rowNumber},event)" required></td>
  <td class="form-input-td"><input type="" name="srate" id="srate${index2}" style="min-width:100px;"  oninput="calculateTotal(${index2})" class="form-control" onkeydown="nextrowkey(event,${index2})" onclick="getrow(${rowNumber},event)" required ></td>
